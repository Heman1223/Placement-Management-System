            ...
            <div className="companies-section">
                ...
                {data?.companies?.length === 0 ? (
                    <div className="empty-state">
                        <Building2 size={48} />
                        <h3>No Company Activity Yet</h3>
                        <p>Companies haven't started engaging with your students yet.</p>
                    </div>
                ) : (
                            ...
                            <div key={company._id} className="company-activity-card">
                                ...
                                <div className="company-stats-grid">
                                    ...
                                    <div className="stat-item">
                                        ...
                                        <span className="stat-value highlight">{company.shortlisted + company.totalShortlisted}</span>
                                    </div>
                                    <div className="stat-item">
                                        <span className="stat-label">Interviewed</span>
                                        <span className="stat-value">{company.interviewed}</span>
                                    </div>
                                    <div className="stat-item">
