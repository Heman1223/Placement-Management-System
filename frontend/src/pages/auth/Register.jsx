...
const Register = () => {
    ...
    return (
        <div className="min-h-screen bg-[var(--bg-cream)] text-[var(--text-brown)] flex items-center justify-center p-4 py-12">
            <div className="w-full max-w-5xl bg-white border border-[var(--accent-brand)]/20 rounded-3xl overflow-hidden shadow-2xl flex flex-col relative">
                {/* Header Section */}
                ...
                <div className="flex-1 p-8 md:p-12 bg-white/50 backdrop-blur-sm">
                    ...
                    {step === 1 && (
                        <div className="space-y-12 animate-in fade-in zoom-in-95 duration-700 text-center">
                            <div className="max-w-2xl mx-auto mb-16">
                                <h1 className="text-5xl md:text-6xl font-black mb-6 text-text tracking-tight">Choose your journey</h1>
                                        ...
                                        <div className="flex flex-col gap-2 w-full">
                                            ...
                                            <div className="relative">
                                                <select
                                                    ...
                                                    onChange={handleChange}
                                                    className="w-full bg-cream border border-border text-text rounded-xl px-4 py-3.5 appearance-none focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all font-medium"
                                                >
                ...
                <div className="p-10 border-t border-border/10 flex justify-center space-x-12 text-[10px] font-black uppercase tracking-[0.3em] text-muted">
